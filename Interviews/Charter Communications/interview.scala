...
object Poker extends App {
  ...
  "8C,9C,10C,JC,QC" winsOver "6S,7H,8D,9H,10D" // straight flush    (10+6) = 16
  "4H,4D,4C,4S,JS" winsOver "6C,6S,KH,AS,AD" // four of a kind      11
  "5C,3C,10C,KC,7C" winsOver "6C,6D,6H,9C,KD" // Flush              10
  "4H,4D,4C,KC,KD" winsOver "9D,6S,KH,AS,AD" // full house          (5+4) = 9
  "2C,3C,4S,5S,6S" winsOver "6C,6D,6H,9C,KD" // straights           6
  "7C,7D,7S,3H,4D" winsOver "9S,6S,10D,AS,AD" // three of a kind	5
  "8C,8H,10S,KH,KS" winsOver "2S,2D,JH,7S,AC" // two pair			(2+2) = 4
  "AC,AH,3C,QH,10C" winsOver "3S,2D,KH,JS,AD" // one pair   		2
  System.exit(0)
}