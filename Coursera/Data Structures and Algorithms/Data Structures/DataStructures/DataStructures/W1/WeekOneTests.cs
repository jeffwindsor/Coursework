...
namespace DataStructures.W1
{
    ...
    public class WeekOneTests : BaseTests
    {
        ...
        {
            TestFromFiles(1, 54, @"W1 - Basic Data Structures\check_brackets_in_code", CheckBracketsInCode.Process);
        }

        [Test]
        public void TreeHeightTests()
        {
            TestFromFiles(1, 24, @"W1 - Basic Data Structures\tree_height", TreeHeight.Process);
        }

        [Test]
        public void NetworkPacketProcessingSimulationTests()
        {
            TestFromFiles(1, 22, @"W1 - Basic Data Structures\network_packet_processing_simulation", NetworkPacketProcessingSimulation.Process);
